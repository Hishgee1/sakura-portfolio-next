...
type Props = Pick<PortfolioData, "notionUrl" | "contact">;

export default function NotionSection({ notionUrl, contact }: Props) {
  return (
    <section id="notes">
      <div className="notion-box glass reveal">
